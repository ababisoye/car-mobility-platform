...
<div><label for="destination_state">Destination state (required for interstate)</label><select id="destination_state" name="destination_state"><option value="">Choose</option>__DESTINATION_STATE_OPTIONS__</select></div>
